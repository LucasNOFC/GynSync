...
const MemberForm = ({ user, id }) => {
  ...
  return (
    <form
      className="m-auto text-white bg-[#1a1a1a] p-5 w-150 rounded 2xl"
      ...
      <div className="p-2 flex flex-col items-center gap-5">
        <div
          className={`
            ...
            `}
        >
          {!id ? "Membro cadastrado com sucesso!" : "Membro editado com sucesso!"}
        </div>
        ...
        <div className="grid grid-cols-2 grid-rows-2 justify-center gap-5">
          ...
          <div className="flex flex-col p-2 gap-2">
            <label className="mb-2 text-gray-300 font-semibold">Telefone</label>
            <input
              {...register("phone", {
